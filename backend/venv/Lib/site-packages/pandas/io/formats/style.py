...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def to_html(
        ...
        **kwargs,
        ...
        doctype_html : bool, default False
            ...
            HTML elements, or just the core ```` and ``<table>`` elements.
        exclude_styles : bool, default False
            Whether to include the ```` element and all associated element
    ...
    def set_table_styles(
        ...
        """
        Set the table styles included within the ```` HTML element.
