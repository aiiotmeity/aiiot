...
import Riverdata from './weather_component/Riverdata';
    ...
    <AuthContext.Provider value={authValue}>
      <Router>
        <Routes>
          ...
          <Route path="/product-details/:productId" element={<ProductOverview />} />
          ...
          <Route path="/realtime-riverforecast" element={<Riverdata />} />
